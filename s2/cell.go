...
func (c Cell) RectBound() Rect {
	...
	switch c.face {
	case 0:
		bound = Rect{Lat: r1.Interval{Lo: -math.Pi / 4, Hi: math.Pi / 4}, Lng: s1.Interval{Lo: -math.Pi / 4, Hi: math.Pi / 4}}
	case 1:
		bound = Rect{Lat: r1.Interval{Lo: -math.Pi / 4, Hi: math.Pi / 4}, Lng: s1.Interval{Lo: math.Pi / 4, Hi: 3 * math.Pi / 4}}
	case 2:
		bound = Rect{Lat: r1.Interval{Lo: poleMinLat, Hi: math.Pi / 2}, Lng: s1.FullInterval()}
	case 3:
		bound = Rect{Lat: r1.Interval{Lo: -math.Pi / 4, Hi: math.Pi / 4}, Lng: s1.Interval{Lo: 3 * math.Pi / 4, Hi: -3 * math.Pi / 4}}
	case 4:
		bound = Rect{Lat: r1.Interval{Lo: -math.Pi / 4, Hi: math.Pi / 4}, Lng: s1.Interval{Lo: -3 * math.Pi / 4, Hi: -math.Pi / 4}}
	default:
		bound = Rect{Lat: r1.Interval{Lo: -math.Pi / 2, Hi: -poleMinLat}, Lng: s1.FullInterval()}
	}
