...
func (m *matrix3x3) det() float64 {
	...
	//      | g  h  i |
	return float64(m[0][0]*m[1][1]*m[2][2]) + float64(m[0][1]*m[1][2]*m[2][0]) + float64(m[0][2]*m[1][0]*m[2][1]) -
		float64(m[0][2]*m[1][1]*m[2][0]) - float64(m[0][1]*m[1][0]*m[2][2]) - float64(m[0][0]*m[1][2]*m[2][1])
}
